<template>
  ...
  <div class="text-center bg-dark h-100 pt-3 d3-icon-item" :class="itemClassColor">
    <div class="d-flex flex-column justify-content-between h-100">
      ...
      <p v-else>
        <!-- Mostramos el nombre del slot y dejamo el contenido vacío -->
        <b-badge class="text-dark">{{ item.slots }}</b-badge>
      </p>
    </div>
  </div>
</template>
...
<style lang="stylus">
  .d3-icon-item
    min-height 100px
    // El borde de la caja va a determinar la rareza del objeto, según el color que tenga
