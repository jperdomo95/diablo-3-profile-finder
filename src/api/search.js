...
// Store, donde se encuentra el token
import store from '../store/index'
// Utilidad de regiones, que nos devolverá el 'locale' por defecto correspondiente a cada región
...
function getApiAccount ({ region, account }) {
  ...
  // Retornamos el resultado de hacer la llamada a la API, es decir, una prmesa
